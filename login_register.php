...
<head>
  <link rel="stylesheet" href="index.css">
	<title>FEST Events - Login or Register</title>
	<style>
		/* .login_button{
  	...
  	<script>
	    $(document).ready(function(){
	        $(".register_button").click(function(){
	          ...
	          $(".register_button").css('background-color','#ee4b19');
	    ...
	    $(document).ready(function(){
	        $(".login_button").click(function(){
	          ...
	          $(".login_button").css('background-color','#ee4b19');
...
<body class='loginbodyh'background="image\second.jpg" >
	<!--Login form-->
